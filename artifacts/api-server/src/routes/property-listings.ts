...
router.post("/property-listings", requireAuth, async (req, res): Promise<void> => {
...
router.patch("/property-listings/:id", requireAuth, async (req, res): Promise<void> => {
...
router.delete("/property-listings/:id", requireAuth, async (req, res): Promise<void> => {
